...
class PartialFC(torch.nn.Module):
    ...
    def __init__(self,
        ...
        self.fp16 = fp16
        self.num_local: int = num_classes // self.world_size + \
                              int(self.rank < num_classes % self.world_size)
        self.class_start: int = num_classes // self.world_size * self.rank + \
                                min(self.rank, num_classes % self.world_size)
